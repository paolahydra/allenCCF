...
image_file_names = dir([image_folder filesep save_file_name '*.tif']); % get the contents of the image_folder
...
for f = 1:length(image_file_names)
    ...
    HistologyCropper_PP_2021Jan3(histology_figure, image_folder, image_file_names(f), atlas_reference_size_um, save_file_name, ordinal)
end
