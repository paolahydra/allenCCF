...
roiLocation_cat_matfile = matfile(fullfile(folder_processed_images, sprintf('%s_roiLocations_All.mat',image_tag)), 'Writable', true); %beware of duplicates
roiTable_cat_matfile = matfile(fullfile(folder_processed_images, sprintf('%s_roiTable_All.mat',image_tag)), 'Writable', true); %beware of duplicates
