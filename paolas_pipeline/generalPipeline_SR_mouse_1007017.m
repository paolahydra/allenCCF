...
image_folder = '/Users/galileo/dati/registered_brains_completed/EnvA_input2isthmus/1007017';   %change this
image_tag = 'mouse_1007017_';                                               %change this - use an unequivocal tag for your experiment
microns_per_pixel = 3.4536; %2.5902; %3.8852; %take this value from your tiff filename

% increase gain if for some reason the images are not bright enough
gain = 4;   % for visualization only: during cropping or atlas alignment
