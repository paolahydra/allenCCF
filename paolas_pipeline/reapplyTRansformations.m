...
% This is just a draft with useful bits of code to apply different
% transformations
%some pieces work but need to be finished,
%others work but need improvement
%others do not work but I may now have a n idea why



% (first run cell detection and cell density algorithms with cellProfiler on
% the preprocessed images)

%% apply the same transformation to other images -> these will be in downsampled atlas reference
% just a demo. The code is unfinished. It loops through but it doesn't save anything
